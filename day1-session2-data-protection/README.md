...
-- Database access
GRANT USAGE ON DATABASE BANK_NUSANTARA_DB TO ROLE BANK_ADMIN;
GRANT USAGE ON DATABASE BANK_NUSANTARA_DB TO ROLE COMPLIANCE_OFFICER;
GRANT USAGE ON DATABASE BANK_NUSANTARA_DB TO ROLE BRANCH_MANAGER_JKT;
GRANT USAGE ON DATABASE BANK_NUSANTARA_DB TO ROLE BRANCH_MANAGER_SBY;
GRANT USAGE ON DATABASE BANK_NUSANTARA_DB TO ROLE BRANCH_MANAGER_BDG;
GRANT USAGE ON DATABASE BANK_NUSANTARA_DB TO ROLE DATA_ANALYST;
GRANT USAGE ON DATABASE BANK_NUSANTARA_DB TO ROLE RISK_ANALYST;
GRANT USAGE ON DATABASE BANK_NUSANTARA_DB TO ROLE TELLER_ROLE;

-- Schema access - RAW_DATA
GRANT USAGE ON SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE BANK_ADMIN;
GRANT USAGE ON SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE COMPLIANCE_OFFICER;
GRANT USAGE ON SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE BRANCH_MANAGER_JKT;
GRANT USAGE ON SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE BRANCH_MANAGER_SBY;
GRANT USAGE ON SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE BRANCH_MANAGER_BDG;
GRANT USAGE ON SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE DATA_ANALYST;
GRANT USAGE ON SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE RISK_ANALYST;
GRANT USAGE ON SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE TELLER_ROLE;

-- Schema access - ANALYTICS
GRANT USAGE ON SCHEMA BANK_NUSANTARA_DB.ANALYTICS TO ROLE BANK_ADMIN;
GRANT USAGE ON SCHEMA BANK_NUSANTARA_DB.ANALYTICS TO ROLE COMPLIANCE_OFFICER;
GRANT USAGE ON SCHEMA BANK_NUSANTARA_DB.ANALYTICS TO ROLE DATA_ANALYST;
GRANT USAGE ON SCHEMA BANK_NUSANTARA_DB.ANALYTICS TO ROLE RISK_ANALYST;

-- Table-level SELECT privileges
GRANT SELECT ON ALL TABLES IN SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE BANK_ADMIN;
GRANT SELECT ON ALL TABLES IN SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE COMPLIANCE_OFFICER;
GRANT SELECT ON ALL TABLES IN SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE BRANCH_MANAGER_JKT;
GRANT SELECT ON ALL TABLES IN SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE BRANCH_MANAGER_SBY;
GRANT SELECT ON ALL TABLES IN SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE BRANCH_MANAGER_BDG;
GRANT SELECT ON ALL TABLES IN SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE DATA_ANALYST;
GRANT SELECT ON ALL TABLES IN SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE RISK_ANALYST;
GRANT SELECT ON ALL TABLES IN SCHEMA BANK_NUSANTARA_DB.RAW_DATA TO ROLE TELLER_ROLE;

GRANT SELECT ON ALL TABLES IN SCHEMA BANK_NUSANTARA_DB.ANALYTICS TO ROLE BANK_ADMIN;
GRANT SELECT ON ALL TABLES IN SCHEMA BANK_NUSANTARA_DB.ANALYTICS TO ROLE COMPLIANCE_OFFICER;
GRANT SELECT ON ALL TABLES IN SCHEMA BANK_NUSANTARA_DB.ANALYTICS TO ROLE DATA_ANALYST;
GRANT SELECT ON ALL TABLES IN SCHEMA BANK_NUSANTARA_DB.ANALYTICS TO ROLE RISK_ANALYST;
```
...
SHOW MASKING POLICIES IN SCHEMA BANK_NUSANTARA_DB.RAW_DATA;

-- Lihat policy references (kolom mana yang pakai policy apa)
SELECT *
FROM TABLE(INFORMATION_SCHEMA.POLICY_REFERENCES(
    POLICY_NAME => 'BANK_NUSANTARA_DB.RAW_DATA.MASK_NIK'
));
```
...
SHOW ROW ACCESS POLICIES IN SCHEMA BANK_NUSANTARA_DB.RAW_DATA;
```
...
```sql
SHOW PROJECTION POLICIES IN SCHEMA BANK_NUSANTARA_DB.RAW_DATA;
```
...
```sql
-- Lihat semua tags
SHOW TAGS IN SCHEMA BANK_NUSANTARA_DB.RAW_DATA;
